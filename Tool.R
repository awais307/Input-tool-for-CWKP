...
setwd(paste0(dirname(current_path),"/Documents"))
...
setwd(paste0(dirname(current_path),"/Documents_backup"))
...
setwd(paste0(dirname(current_path),"/HTML_LINKS"))
...
setwd(paste0(dirname(current_path),"/Phantom/phantomjs-2.1.1-windows/bin"))
...
##Step 6: To create tables for exporting information to PostgreSQL i.e. based in UNU-Flores relational tables framework
...
postgis_update(con2, SITES_up, "SITES", id_cols=c("SITE_ID"),update_cols=c("SYSTEM_ID","CTRY_CODE"))
